...
def dream_team(df_pivot, n_next_rounds, fixtures, budget_limit=84):
    ...
    # Set the position requirements constraint
    ...
    # Set the constraint on the maximum number of players from a single team
    ...
    # Print the selected players, their positions, and expected points
